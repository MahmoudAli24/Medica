...
const CourseVideosCardItem = ()=>{
    return(
        <div className={'flex items-center justify-between flex-wrap bg-[#F7F8F8] px-4 py-1 rounded-full'}>
            <div className={'flex items-center gap-3'}>
                            <div
                                className={"text-white rounded-full bg-gradient-to-tr from-[#31C7FE] to-[#00F2FE]"}>
                ...
                <TypographyLead className={"flex items-center gap-2 w-full"}>
                            <span
                                className={"inline-block px-2 text-white font-bold bg-[#31C7FE] rounded "}>1</span>
                    Difference between coding and transcriptions
                </TypographyLead>
            </div>
